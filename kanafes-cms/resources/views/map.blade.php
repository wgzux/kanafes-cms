    ...
    <div class="container about__body">
        ...
        <div class="body__image">
            ...
            <div class="image__desc">
                <div class="color__item">
                    ...
                    <p class="color__text">協賛者</p>
                </div>
                <div class="color__item">
                    <div class="color__box"></div>
                    <p class="color__text">飲食</p>
                </div>
                <div class="color__item">
                    <div class="color__box"></div>
                    <p class="color__text">主催者</p>
                </div>
                <div class="color__item">
                    <div class="color__box"></div>
                    <p class="color__text">物販</p>
                </div>
                <div class="color__item">
                    <div class="color__box"></div>
                    <p class="color__text">ハノイ市ブース</p>
                </div>
            </div>
        </div>
        ...
        <div class="booth__group">
            ...
            <div class="booth-container">
                ...
                <div class="booth__item"><div class="booth__number">17</div><p class="booth__desc">The Japan-Vietnam Association - a Public Interest Incorporated Association -</p></div>
                <div class="booth__item"><div class="booth__number">18</div><p class="booth__desc">Foundation of Japan - Vietnam Cultural Association - Since 1992 -</p></div>
                <div class="booth__item"><div class="booth__number">24</div><p class="booth__desc">漢字＆習字 【HANOI UNIV CCJLC】</p></div>
                <div class="booth__item"><div class="booth__number">25</div><p class="booth__desc">未病（Mibyo）Blood pressure test &amp; green juice tasting<br>東京リブロヘルスケア</p></div>
            </div>
            <div class="booth-container">
