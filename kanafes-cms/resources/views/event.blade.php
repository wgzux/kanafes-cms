                ...
                <div class="content__body">
                    <div class="content__body-half">
                        ...
                        <div class="content__body-text">
                            <h3>城崎桃華</h3>
                            <p>
                                アニソンシンガー兼声優の城崎桃華が、ベトナムの若者も知っている日本の有名なアニソン曲を歌唱します。<br>
                    ...
                    <div class="content__body-half">
                        ...
                        <div class="content__body-text">
                            <h3>LYLY</h3>
                            <p>
                                ベトナム音楽界で多彩な才能と優れた業績を誇るLYLYがスペシャルライブを披露。<br>
            ...
            <div class="event__body-content">
                ...
                <div class="content__body">
                    ...
                    <div class="content__body-text">
                        <h3>Hoàng Dũng</h3>
                        <p>
                            スペシャルゲストに、繊細で洗練された歌声と豊かな表現力が魅力のHoàng Dũng（ホアン・ズン）が登場！代表曲「Nàng Thơ」（ナン・トー）などで幅広い世代に支持され、国際的なコラボも話題の人気シンガーソングライター。貴重なライブをぜひご覧ください!<br>
