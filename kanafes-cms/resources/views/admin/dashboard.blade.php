    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white rounded-xl shadow-sm p-5">
            ...
            <div class="grid grid-cols-2 gap-3">
                <a href="{{ route('admin.banner.index') }}"
                    class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-red-50 transition group">
        ...
        <div class="bg-white rounded-xl shadow-sm p-5">
            ...
            <ul class="space-y-2 text-sm text-gray-600">
                ...
                <li class="flex gap-2"><span class="text-blue-500">•</span> Logo nhà tài trợ Kim cương sẽ hiển thị lớn nhất
                </li>
                <li class="flex gap-2"><span class="text-blue-500">•</span> YouTube link phải ở dạng embed (/embed/...)</li>
                <li class="flex gap-2"><span class="text-green-500">✓</span> Mọi thay đổi cập nhật ngay lập tức lên trang
                    web</li>
            </ul>
        </div>
    </div>
